...
Read [the source audit](research/SOURCE-AUDIT.md) and [pilot notes](research/OPENING-PILOT.md) before translating. Current status: five printed candidate PDFs plus one complete manuscript scan acquired, 405,122 extracted digital positions from the printed witnesses (not certified verses), and no certified crosswalk to the archival aggregate. The compiled and [live draft](https://manas-every-line.bentsignal.chatgpt.site) contains 388,432 translated rows and 2,044,578 English words. Seven source-gap regions remain explicitly accounted for; exact details are recorded in [draft progress](corpus/draft-progress.json) and the live manifest. An existing Turkish–English Karalaev trilogy project has also been identified; its coverage and counts do not establish a complete 500,553-line translation. Completion-first acquisition priorities are recorded in [the current reconciliation](research/COMPLETION-PRIORITY-2026-09-15.md).
